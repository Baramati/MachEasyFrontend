...
@Component({
  selector: 'app-fin-mast-code-list',
  templateUrl: './fin-mast-code-list.component.html',
  styleUrls: ['./fin-mast-code-list.component.css']
})
export class FinMastCodeListComponent {
  ...
  onCreate() {
    this.offcanvasService.openDynamicComponent({
      mainComponentPath: this.menu_details[0].MENU_OPT_PAGE,
      mainComponentClass: this.menu_details[0].CLASS_NAME,
      mainComponentTitle: '',
      queryParams: {
        status: "Add"
      },
